    ...
    * v0: Initial versions release (1.0.0)
    ...
    def step(self, action):
        ...
        if action:  # hit: add a card to players hand and return
            ...
            if self.sab and is_natural(
                    self.player) and not is_natural(self.dealer):
    ...
    def render(self, mode="human"):
        ...
        small_font = get_font(os.path.join("font", "Minecraft.ttf"),
                              screen_height // 15)
        dealer_text = small_font.render("Dealer: " + str(dealer_card_value),
                                        True, white)
        ...
        def scale_card_img(card_img):
            return pygame.transform.scale(card_img,
                                          (card_img_width, card_img_height))

        dealer_card_img = scale_card_img(
            get_image(
                os.path.join("img", dealer_card_suit + dealer_card_value_str +
                             ".png")))
        ...
        large_font = get_font(os.path.join("font", "Minecraft.ttf"),
                              screen_height // 6)
